package com.jcloudify.app.unit;
...
import com.jcloudify.app.conf.FacadeIT;
import com.jcloudify.app.endpoint.event.consumer.model.ConsumableEvent;
import com.jcloudify.app.endpoint.event.consumer.model.ConsumableEventTyper;
import com.jcloudify.app.endpoint.event.consumer.model.TypedEvent;
import com.jcloudify.app.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.jcloudify.app.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.jcloudify.app.endpoint.event.model.UuidCreated", payload);
