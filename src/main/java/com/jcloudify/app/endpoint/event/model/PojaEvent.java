package com.jcloudify.app.endpoint.event.model;

import static com.jcloudify.app.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.jcloudify.app.PojaGenerated;
import com.jcloudify.app.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.jcloudify.app.event1";
    return "com.jcloudify.app.event2";
  }
}
